        ...
        <div className="wrapper">
            ...
            <main>
                <div className="about-us">
                    ...
                    <p>
                        Our story, which began in 2018, is one of a constantly growing family of
                        loyal customers, as well as one of discovery: our favorite brands come from
                        all around the world and we are as excited about them as our clients are.
                    </p>
                    <p>
                        Lusso is <strong>the first and only store</strong> to represent such{' '}
                        <strong>high-end brands</strong> of homeware, gifts, accessories and home
                        décor.
                    </p>
                    <p>Our name and reputation are our most important investment.</p>
                    <p>
                    ...
                    <p>
                        <strong>Our customers know</strong> that Lusso only showcases items from
                        well selected, exclusive and reputable companies of home décor and gifts.
                    </p>
                    ...
                    <p>We pride ourselves on our long-lasting and beautiful partnerships.</p>
                    <p>
                        Lusso has also expanded its home decor universe with the works of Moldovan
                        sculptors.
                    </p>
                    <p>
                        Our art collection highlights the pioneer artisans’ signature aesthetic and
                        brings a range of everyday objects that are sculptural, organic and
                        captivating.
                    </p>
                    <p>
                        We care a lot about the aesthetics of the products in our store, their
                        proper positioning and presentation on the shelf. You can see how we handle
                        these aspects in our everyday social media posts.
                    </p>
                    <p>This fits our philosophy of a personalized approach for every customer.</p>
                    <p>
                        For 2022 we aim to grow up together with both old and new partners. To reach
                        even more customers in Moldova.
                    </p>
                    <p>
                        We understand that this is a big responsibility. Nevertheless, we believe
                        that our shared values and vision make us a reliable partner.
                    </p>
                    <Founder />
                </div>
            </main>
